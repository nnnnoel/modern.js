...
`,t(e.p,{children:["Static resource output path, will be based on ",o(e.a,{href:"/module-tools/zh/api/build-config/#outdir",children:o(e.code,{children:"outdir"})})]}),`
`,t(e.ul,{children:[`
...
`,t(e.p,{children:["The output path of the dts file, based on ",o(e.a,{href:"/module-tools/'/zh/api/build-config/#outdir'",children:o(e.code,{children:"outdir"})})]}),`
`,t(e.ul,{children:[`
`,t(e.li,{children:["type: ",o(e.code,{children:"string"})]}),`
...
\`\`\`
`;export{n as CH,r as chCodeConfig,D as content,f as default,F as frontmatter,m as lastUpdatedTime,y as title,g as toc};
